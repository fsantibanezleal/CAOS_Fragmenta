...
| [Guides](guides.md) | running the bake, bringing your own blasts, reading a number |
...
fragmentation without caring about Fragmenta belongs upstream, and keeping the boundary strict is
