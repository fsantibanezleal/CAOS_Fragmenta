...
_REAL_SITES: tuple[tuple[str, str, str, str, str, str], ...] = (
    ...
    "only 1.33 burdens tall."
        ...
        (
    "La roca mas rigida del conjunto, 60 GPa, en un esquisto plegado. Tambien es donde el indice "
    "de uniformidad baja mas, porque el taco ocupa casi todo un banco de solo 1.33 bordos."
        ),
    ...
    "sits in both the training table and the published validation set."
        ...
        (
    "El mayor bordo del conjunto, 6.0 m con perforacion de 229 mm. Su tiro Rc1 es el que aparece "
    "tanto en la tabla de entrenamiento como en el conjunto de validacion publicado."
        ),
    ...
    "diametro es el que la fuente nunca publico, recuperado invirtiendo la altura declarada y "
    ...
    "this product were wrong, this case would show it."
        ...
        (
    "El control de geometria. Su parrafo fuente declara altura de banco, rango de bordo y rango "
    "de espaciamiento, y la reconstruccion reproduce los tres exactamente. Si la aritmetica de "
    "este producto estuviera mal, este caso lo mostraria."
        ),
    ...
    "the bench."
        ...
        (
    "Andesita con la perforacion mas pequena del conjunto, 76 mm, en un banco de 15 m. Aqui el "
    "indice de uniformidad alcanza sus valores mas altos, porque la columna de carga es larga "
    "respecto del banco."
        ),
    ...
    (
        ...
        "Cuenca carbonifera de Soma, Turquia",
        (
    ...
    "travels with the case."
        ...
        (
    "El caso que arrastra un conflicto sin resolver en la fuente. Su parrafo declara un bordo de "
    "5 m y una perforacion de 21 cm, y las razones no admiten ambos. Tomar el diametro "
    "reproduce exactamente el espaciamiento y la altura declarados, asi que se usa el diametro y "
    ...
    "predicts 0.08 m against 0.35 m measured."
        ...
        (
    "La roca mas debil del conjunto, 9.57 GPa, y el menor factor de roca recuperado, 3.68. "
    "Tambien es donde el modelo clasico falla mas: en el tiro de validacion de este sitio "
    ...
    "the highest powder factors in the set."
        ...
        (
    "El sitio mas grande del conjunto, 22 de los 97 tiros, razon por la cual las filas no son "
    ...
    "pattern, which is the closest thing this corpus has to a controlled comparison."
        ...
        (
    "La cantera hermana de Akdaglar: la misma arenisca y la misma perforacion de 89 mm sobre "
    "otra malla, lo mas parecido a una comparacion controlada que ofrece este conjunto."
        ),
...
def _real_cases() -> list[Case]:
    ...
    cases.append(
        Case(
            ...
            title_es="Mina Miami, Arizona: el control negativo de geometria",
            reason_en=(
            ...
            reason_es=(
                "Nada en la fuente fija la escala absoluta de este sitio: sin diametro de "
                "perforacion, sin altura de banco, sin bordo. Todo modelo que necesite volumen de "
                "roca y masa de carga debe ABSTENERSE en estos seis tiros, con una razon. Un numero "
                "aqui seria una invencion, y este caso existe para que la negativa sea visible."
            ),
    ...
    cases.append(
        Case(
            ...
            title_es="Mina de granito, noreste de China: el control de extrapolacion",
            reason_en=(
            ...
            reason_es=(
                "Cinco tiros de produccion medidos por analisis de imagen, y el unico conjunto real "
                "de este producto que queda FUERA de la envolvente ajustada. Su modulo de Young de "
                "5.6 GPa esta bajo el minimo del corpus, 9.57, en la variable que dos estudios "
                "independientes califican como la mas importante. Toda prediccion aqui se marca "
                "como extrapolacion. Es tambien el unico conjunto que publica su malla absoluta, "
                "asi que verifica la reconstruccion geometrica en vez de consumirla."
            ),
...
_SYNTHETIC: tuple[Case, ...] = (
    Case(
        ...
        reason_es=(
            "Aisla el bordo manteniendo todo lo demas. Cada campana real varia varias cosas a la "
            "vez, de modo que ningun caso real muestra una respuesta limpia a una sola palanca. "
            "Esta es la columna de la superficie de respuesta de diseno."
        ),
    ...
    Case(
        ...
        title_es="Barrido de factor de carga con geometria fija",
        reason_en=(
        ...
        reason_es=(
            "El eje economico. El explosivo es el lugar mas barato para fragmentar roca, y esta es "
            "la curva que dice cuanto mas fino compra cada kilogramo por metro cubico adicional."
        ),
    ...
    Case(
        ...
        reason_es=(
            "Lleva el tamano de bloque in situ al tope del rango del corpus mientras la malla sigue "
            "agresiva. El punto es la cola gruesa: ninguna cantidad de explosivo fragmenta mas fino "
            "que la estructura de juntas sin energia para hacerlo, y aqui se ve."
        ),
    ...
    Case(
        ...
        title_es="Diseno degenerado: el control negativo",
        reason_en=(
        ...
        reason_es=(
            "Un diseno que no es un tiro: el taco excede la perforacion, de modo que no hay carga "
            "que detonar. Todo modelo debe rechazarlo en vez de devolver un numero verosimil. Si "
            "algun modelo responde aqui, el producto esta fabricando."
        ),
    ...
    Case(
        ...
        title_es="Diseno recuperable: el control positivo",
        reason_en=(
        ...
        reason_es=(
            ...
            "estos numeros no puede reproducirlos, la instalacion esta rota y ningun otro resultado "
            "de esta pagina es confiable."
        ),
